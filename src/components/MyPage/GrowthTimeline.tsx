    ...
    <section className="w-[950px]">
      ...
      >
        ...
        <div className="grid grid-cols-[180px_1fr_220px] items-end pb-6">
          <h4 className="font-vt text-3xl tracking-wider text-[#5A2B55]">TIME</h4>
          <h4 className="font-vt justify-self-center text-3xl tracking-wider text-[#5A2B55]">
            FISH
          </h4>
          <h4 className="font-vt text-3xl tracking-wider text-[#5A2B55]">MATURITY</h4>
        </div>
        ...
        <div className="space-y-8">
          {items.map((it) => (
            <div key={it.id} className="grid grid-cols-[180px_1fr_220px] items-center">
              {/* TIME */}
              <div className="font-vt text-3xl leading-relaxed text-white">
                {it.at.split(" ")[0]}
                <br />
                {it.at.split(" ")[1]}
              </div>
              ...
              {/* MATURITY */}
              <div className="font-vt text-3xl text-white">{it.fish.maturity}</div>
            </div>
          ))}
        </div>
      </div>
